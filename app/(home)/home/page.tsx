          ...
          >
              ...
              >
                ...
                >
                  ...
                  <Paragraph style={{ fontWeight: 600 }}>
                    AppointMed menjadi solusi klinik Anda dalam mengelola janji
                    temu, pasien,
                    <br /> dan staf dengan mudah.
                  </Paragraph>
            ...
            <Section>
              <Flex
                ...
                justify="center"
                align="center"
                style={{ zIndex: 1, marginTop: "4.8rem" }}
              >
                <Flex
                  justify="center"
                  align="center"
                ...
                >
                  ...
                  >
                    ...
                    <p style={{ fontSize: "15px", marginBottom: "20px" }}>
                      Pasien Anda bisa melakukan reservasi online melalui
                      website kapan saja dan di mana saja
                    </p>
                      ...
                      <Flex gap={10} justify="space-around">
                        <Flex vertical justify="center" gap={10}>
                          ...
                          <p style={{ textAlign: "center", fontSize: "11px" }}>
                            ...
                            karena pelanggan telah melakukan pembayaran terlebih
                            dahulu
                          </p>
                        </Flex>
                        <Flex vertical justify="center" gap={10}>
                      ...
                      <Flex gap={10}>
                        ...
                        <Flex vertical wrap={"wrap"}>
                          <p style={{ fontSize: "14px" }}>
                            Lihat perkembangan jumlah pasien dan pendapanan
                            klinik Anda
                          </p>
                        </Flex>
                      </Flex>
                ...
                >
                  ...
                  >
                    ...
                    <Flex vertical>
                      ...
                      >
                        Rp 250.000
                        <span style={{ fontSize: "12px" }}>/bulan</span>
                      </p>
                      <p
                        style={{
                          color: "white",
